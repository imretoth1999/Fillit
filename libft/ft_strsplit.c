...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/27 10:23:25 by bbardi            #+#    #+#             */
/*   Updated: 2016/12/27 10:26:22 by bbardi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		nr_cuv(char *str, char ch)
{
	int result;
...
static char		**split_func(char *str, int n, int *i, char ch)
{
	int		i3;
	int		word_size;
	char	**result;
...
char			**ft_strsplit(char const *s, char c)
{
	...
	if (s && c)
	{
		i[0] = 0;
		i[1] = 0;
		return (split_func((char*)s, nr_cuv((char*)s, c), i, c));
	}
	return (NULL);
}
